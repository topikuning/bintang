...
async def fixt(db: AsyncSession):
    ...
    sup = User(
        ...
        telegram_chat_id="tg-sup",
        whatsapp_chat_id="wa-sup",
    )
    cad = User(
        name="Cad",
        email="cad@x",
    ...
    pad_a = User(
        ...
        telegram_chat_id="tg-pa",
        whatsapp_chat_id="wa-pa",
    )
    pad_b = User(
    ...
    creator = User(
        ...
        password_hash="x",
        role=UserRole.PROJECT_ADMIN,
        telegram_chat_id="tg-cre",
        whatsapp_chat_id="wa-cre",
    )
    nolink = User(
