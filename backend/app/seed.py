    ...
    async with SessionLocal() as db:
        ...
        cats_in = [
            Category(
                ...
                description="Pencairan termin dari client",
            ),
            Category(
                name="DP Client", type=CategoryType.IN, description="Down payment di awal proyek"
            ),
        ...
        cats_out = [
            ...
            Category(
                ...
                description="Konsumsi, transport, BBM",
            ),
        ...
        v_beton = VendorClient(
            name="CV Mitra Beton Pratama",
            type=VendorClientType.VENDOR,
            phone="021-7700-2222",
            npwp="04.111.222.3-091.000",
            contact="Bu Yanti",
        )
        v_alat = VendorClient(
            name="PT Sewa Alat Jaya",
            type=VendorClientType.VENDOR,
            phone="031-8800-3333",
            contact="Pak Hadi",
        )
        v_subkon = VendorClient(
            name="CV Karya Mandiri Subkon",
            type=VendorClientType.VENDOR,
            phone="022-9900-4444",
            contact="Pak Rizal",
        )
        c_sukses = VendorClient(
            name="PT Klien Sukses Makmur",
            type=VendorClientType.CLIENT,
            phone="021-1111-5555",
            contact="Bp. Tanto",
            npwp="05.222.333.4-091.000",
        )
        c_persada = VendorClient(
            name="PT Persada Properti",
            type=VendorClientType.CLIENT,
            phone="021-2222-6666",
            contact="Ibu Siska",
        )
        c_griya = VendorClient(
            name="Griya Asri Group",
            type=VendorClientType.CLIENT,
            phone="022-3333-7777",
            contact="Bp. Doni",
        )
        ...
        p1 = Project(
            ...
            project_value=Decimal("714000000"),
        ...
        p2 = Project(
            ...
            project_value=Decimal("429000000"),
        ...
        p3 = Project(
            ...
            project_value=Decimal("286000000"),
        ...
        p4 = Project(
            ...
            project_value=Decimal("114000000"),
        ...
        p5 = Project(
            ...
            project_value=Decimal("2143000000"),
        ...
        all_txs += [
            ...
            tx(
                ...
                25_000_000,
                "Mandor Joko & Tim",
                party_type=PartyType.PERSONAL,
                desc="Upah tukang minggu 1-2",
        ...
        all_txs += [
            tx(
                ...
                c_dp,
                60_000_000,
                "PT Klien Industri Maju",
                desc="DP renovasi pabrik",
            ),
            tx(p3, 50, TxnType.IN, c_termin, 80_000_000, "PT Klien Industri Maju", desc="Termin 1"),
            tx(
                p3,
                70,
                TxnType.OUT,
        ...
        inv1 = Invoice(
            ...
            vendor_client_id=c_sukses.id,
            party_name="PT Klien Sukses Makmur",
        ...
        inv1.items.append(
            InvoiceItem(
                description="Pekerjaan struktur lantai 2-3",
                quantity=Decimal("1"),
                unit="lot",
        ...
        inv1.items.append(
            InvoiceItem(
                description="Finishing dinding & lantai",
                quantity=Decimal("1"),
                unit="lot",
        ...
        inv2 = Invoice(
            ...
            invoice_date=d(35),
            due_date=d(20),
            vendor_client_id=c_persada.id,
            party_name="PT Persada Properti",
        ...
        inv2.items.append(
            InvoiceItem(
                description="DP 30% pembangunan ruko 3 unit",
                quantity=Decimal("1"),
                unit="lot",
        ...
        inv3.items.append(
            InvoiceItem(
                description="Pekerjaan struktur 3 unit ruko",
                quantity=Decimal("3"),
                unit="unit",
                unit_price=Decimal("50000000"),
        ...
        inv4.items.append(
            InvoiceItem(
                description="Pekerjaan struktur lantai 5-7",
                quantity=Decimal("3"),
                unit="lantai",
                unit_price=Decimal("100000000"),
        ...
        inv5 = Invoice(
            ...
            invoice_date=d(50),
            due_date=d(35),
            vendor_client_id=v_sentosa.id,
            party_name="Toko Bangunan Sentosa",
            status=InvoiceStatus.PAID,
        ...
        inv5.items.append(
            InvoiceItem(
                description="Semen Tiga Roda 50kg",
        ...
        inv5.items.append(
            InvoiceItem(
                description="Besi beton diameter 12mm",
        ...
        inv6 = Invoice(
            ...
            invoice_date=d(40),
            due_date=d(10),
            vendor_client_id=v_subkon.id,
            party_name="CV Karya Mandiri Subkon",
            status=InvoiceStatus.OVERDUE,
        ...
        inv6.items.append(
            InvoiceItem(
                description="Subkon pekerjaan baja & atap",
                quantity=Decimal("1"),
                unit="lot",
        ...
        for t in all_txs:
            if t.project_id == p1.id and t.type == TxnType.OUT and t.amount == Decimal("45000000"):
        ...
        po1 = PurchaseOrder(
            ...
            project_id=p1.id,
            company_id=bka.id,
            vendor_client_id=v_beton.id,
            vendor_name="CV Mitra Beton Pratama",
            po_date=d(28),
            needed_date=d(20),
        ...
        po2 = PurchaseOrder(
            ...
            company_id=bka.id,
            vendor_client_id=v_sentosa.id,
            vendor_name="Toko Bangunan Sentosa",
            po_date=d(15),
            needed_date=d(10),
        ...
        po2.items.append(
            POItem(
                description="Bata ringan AAC 7.5cm",
        ...
        po3 = PurchaseOrder(
            ...
            project_id=p5.id,
            company_id=nusantara.id,
            vendor_client_id=v_alat.id,
            vendor_name="PT Sewa Alat Jaya",
            po_date=d(40),
            needed_date=d(35),
        ...
        po3.items.append(
            POItem(
                description="Sewa Tower Crane 50m",
                quantity=Decimal("1"),
                unit="bulan",
